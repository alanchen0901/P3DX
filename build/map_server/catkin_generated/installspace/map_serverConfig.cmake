...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cirlab/pioneer/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cirlab/pioneer/install/lib;/home/cirlab/pioneer/devel/lib;/home/cirlab/catkin_four/devel/lib;/home/cirlab/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
